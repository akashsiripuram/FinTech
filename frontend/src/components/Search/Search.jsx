...
export default function Search() {
  ...
  const handleSubmit = async (e) => {
    ...
    // Log the expenseData to check for empty values
    console.log('Expense Data:', expenseData);
  
    // Ensure all fields are present and valid
    if (!expenseData.date || !expenseData.note || !expenseData.expense || !expenseData.category) {
    ...
    try {
      ...
      if (response.ok) {
        ...
        console.error('Failed to submit expense:', errorData.message);
      }
    } catch (error) {
